...
def preprocess_input(data):
    ...
    processed_data['gender_Female'] = 1 if gender == 'Female' else 0
    processed_data['gender_Male'] = 1 if gender == 'Male' else 0
    processed_data['gender_Other'] = 1 if gender == 'Other' else 0
    ...
    for category in smoking_categories:
        ...
        processed_data[col_name] = 1 if smoking_history.lower() == category.lower().replace("_", " ") else 0
